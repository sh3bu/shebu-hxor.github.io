---
layout: post
title: "Tryhackme — Lockdown Writeup"
date: 2021-11-27  
...
![upload](../../assets/img/posts/Lockdown/upload)
...
```sql
www-data@lockdown:/var/www/html/classes$ mysql -h localhost -u cts -pYOUMKtIXoRjFgMqDJ3WR799tvq2UdNWE -D cts_db       
...
Now we have the password .Lets  switch user to `cyrus`.
## user.txt 🚩
